...
class MountainCategoryPage extends StatefulWidget {
  const MountainCategoryPage({Key? key}) : super(key: key);

  @override
  State<MountainCategoryPage> createState() => _MountainCategoryPageState();
}

class _MountainCategoryPageState extends State<MountainCategoryPage> {
  String placeholder =
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GridView.builder(
          ...
          shrinkWrap: true,
          itemCount: mountainModel.mountain?.length ?? 3,
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: 2, mainAxisSpacing: 30, crossAxisSpacing: 20),
          itemBuilder: (context, index) {
            final item = mountainModel.mountain?[index];
            return InkWell(
